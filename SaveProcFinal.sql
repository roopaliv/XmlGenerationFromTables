...
FROM [opera].[ivp_polaris_report_non_netted_values] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaNonNetted tnnv WITH (NOLOCK) on tnnv.id = d.id
...
SELECT nnv.[report_id],[fund_id],[fund_name],nnv.[section_id],nnv.[sub_section_id] ,nnv.[reporting_date],nnv.[grade_1],nnv.[grade_2] ,nnv.[grade_3]          
...
,nnv.[values] FROM [opera].[ivp_polaris_report_non_netted_values] nnv WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaNonNetted tnnv WITH (NOLOCK) on tnnv.id = nnv.id 
...
FROM [opera].[ivp_polaris_report_netted_values] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaNetted tnv WITH (NOLOCK) ON tnv.id = d.id
...
SELECT nv.[report_id],[fund_id],[fund_name],nv.[section_id],nv.[sub_section_id] ,nv.[reporting_date],nv.[grade_1],nv.[grade_2] ,nv.[grade_3]          
...
FROM [opera].[ivp_polaris_report_fund_investor_details] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaFidv tfidv WITH (NOLOCK) on tfidv.id = d.id
...
,[knowledge_date] ,[created_on] ,[created_by] ,[modified_on]  ,[modified_by] ,[is_active])
SELECT fidv.[report_id],[fund_id],[fund_name],fidv.[section_id],fidv.[sub_section_id] ,fidv.[reporting_date],fidv.[grade_1],fidv.[grade_2] ,fidv.[grade_3]          
...
FROM [opera].[ivp_polaris_report_fund_sensitivity_details] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaSns tsns WITH (NOLOCK) on tsns.id = d.id  
...
[level] ,[is_user_edited] ,[loading_date]
,[knowledge_date] ,[created_on] ,[created_by] ,[modified_on]  ,[modified_by] ,[is_active])
SELECT sns.[report_id],[fund_id],[fund_name],sns.[section_id],sns.[sub_section_id] ,sns.[reporting_date],sns.[grade_1],sns.[grade_2] ,sns.[grade_3]          
...
FROM [opera].[ivp_polaris_report_fund_stress_test] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaSt tst WITH (NOLOCK) on tst.id = d.id
...
[level] ,[is_user_edited] ,[loading_date]
,[knowledge_date] ,[created_on] ,[created_by] ,[modified_on]  ,[modified_by] ,[is_active])
SELECT st.[report_id],[fund_id],[fund_name],st.[section_id],st.[sub_section_id] ,st.[reporting_date],st.[grade_1],st.[grade_2] ,st.[grade_3]          
...
FROM [opera].[ivp_polaris_report_counterparty_details] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaCp tbcp WITH (NOLOCK) on tbcp.id = d.id 
...
[level] ,[is_user_edited] ,[loading_date]
,[knowledge_date] ,[created_on] ,[created_by] ,[modified_on]  ,[modified_by] ,[is_active])
SELECT cp.[report_id],[fund_id],[fund_name],cp.[section_id],cp.[sub_section_id] ,cp.[reporting_date],cp.[grade_1],cp.[grade_2] ,cp.[grade_3]          
...
FROM [opera].[ivp_polaris_report_value_at_risk] d WITH (NOLOCK)
JOIN #DataToBeInsertedForOperaRsk trsk WITH (NOLOCK) on trsk.id = d.id
...
[level] ,[is_user_edited] ,[loading_date]
,[knowledge_date] ,[created_on] ,[created_by] ,[modified_on]  ,[modified_by] ,[is_active])
SELECT rsk.[report_id],[fund_id],[fund_name],rsk.[section_id],rsk.[sub_section_id] ,rsk.[reporting_date],rsk.[grade_1],rsk.[grade_2] ,rsk.[grade_3]          
